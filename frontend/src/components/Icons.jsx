/**
 * Inline SVG icons — replaces emoji usage throughout the app.
 * Each icon is a clean, consistent 24x24 SVG with currentColor.
 */
...
export function IconFlask(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M10 9V3" />
      <path d="M14 9V3" />
      <path d="M10 9 5.2 17.6A2 2 0 0 0 7 21h10a2 2 0 0 0 1.8-3.4L14 9" />
    </svg>
  );
}
